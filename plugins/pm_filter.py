...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("😁 𝗛𝗲𝘆 𝗙𝗿𝗶𝗲𝗻𝗱,𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗬𝗼𝘂𝗿𝘀𝗲𝗹𝗳 സ്വന്തമായി റിക്വസ്റ്റ് ചെയ്യൂ,കണ്ടവരുടെ മുത്തലിൽ തുടരുത് ✋✋.", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if not search:
        await query.answer("𝐋𝐢𝐧𝐤 𝐄𝐱𝐩𝐢𝐫𝐞𝐝 𝐊𝐢𝐧𝐝𝐥𝐲 𝐏𝐥𝐞𝐚𝐬𝐞 𝐒𝐞𝐚𝐫𝐜𝐡 𝐀𝐠𝐚𝐢𝐧 🙂.കാലാവധി കഴിഞ്ഞ് പൊഴി 😄", show_alert=True)
        return
    ...
    if n_offset == 0:
        ...
        btn.append(
            [InlineKeyboardButton(f"📄 ႲႩႺპ {round(int(offset) / 10) + 1} / {round(total / 10)}", callback_data="pages"),
             InlineKeyboardButton("🅽︎🅴︎🆇︎🆃︎ ➡️", callback_data=f"next_{req}_{key}_{n_offset}")])
    else:
        btn.append(
            [
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == "private":
            ...
            if (st.status == "creator") or (str(userid) in ADMINS):
                ...
                await query.answer("Buddy Don't Touch Others Property 😁, മറ്റുള്ളവരുടെ പ്രോപ്പർട്ടി യിൽ തൊട്ട് പോകരുത് ✋✋", show_alert=True)
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton(text="👁️ 𝖡𝗅𝗎𝗋", callback_data="blur"),
            ...
            InlineKeyboardButton(text="✨️ 𝖲𝖾𝗉𝗂𝖺", callback_data="sepia"),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😎 𝙾𝚆𝙽𝙴𝚁 ', user_id=1733124290)
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('𝙿𝙰𝙸𝙳 𝙿𝚁𝙾𝙼𝙾𝚃𝙸𝙾𝙽👁️‍🗨️', url='https://t.me/Paid_promote_RobOt'),
            InlineKeyboardButton('𝙵𝚁𝙴𝙴 𝙿𝚁𝙾𝙼𝙾𝚃𝙸𝙾𝙽⚠️', url='https://t.me/Free_promote_RobOt')
        ],[
            InlineKeyboardButton('𝙼𝙰𝙸𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻✌️', url='https://t.me/bot_cracker')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('вrσthєr😎', callback_data='broz')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('M𝙾ΓHΞЯ🤙', url='https://t.me/mod_moviezx'),
            InlineKeyboardButton('✌️', url='https://t.me/bot_cracker')
        ],[
            InlineKeyboardButton('GRΔΠD ҒΔTHΣR👴', url='https://t.me/nt_backup')
        ],[
            InlineKeyboardButton('🏠 𝙷𝙾𝙼𝙴 🏠', callback_data='start'),
        ...
        R1 = await query.message.reply_photo(
                 photo="https://telegra.ph/file/2e2a07e86066538ed706.jpg",
        ...
        buttons = [[
            InlineKeyboardButton('𝙱𝙰𝙲𝙺🚶', callback_data='about'),
            InlineKeyboardButton('𝚁𝙴𝙵𝚁𝙴𝚂𝙷♻️', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f" 𝙿𝙰𝙶𝙴 📜 1/{round(int(total_results) / 6)}", callback_data="pages"),
             InlineKeyboardButton(text=" ΠΣXT ➡️", callback_data=f"next_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
            [InlineKeyboardButton(text="❇️ 𝙳𝙰𝚃𝙰𝙱𝙰𝚂𝙴 ❇️", url="https://t.me/+3-nuV_9INIg0MDY1"),
